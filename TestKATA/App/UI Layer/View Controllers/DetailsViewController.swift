    ...
    override func viewDidLoad() {
        ...
        timer =  Timer.scheduledTimer(withTimeInterval: 6.0, repeats: true) { [self] timer in
            if currentIndex < messages.count {
                ...
                currentIndex = 0 // Réinitialiser l'index lorsque tous les messages ont été affichés
            }
        }
              // Créez un timer pour mettre à jour la barre de progression toutes les 1 seconde
